...
<body class="theme-light" data-highlight="highlight-red" data-gradient="body-default">
	...
	<div id="page">
		...
		<!-- <div class="header header-fixed header-logo-center container-fluid">
					<div class="row">
						<div class="col-6 breadcrumb">
							<span class="home_icon ms-2 mt-2"><i class="fas fa-home"></i></span>
							<span class="path ms-3 mt-2">
									<?= $path ?>
							</span>
						</div>
					</div>
		...
		<div id="footer-bar" class="footer-bar-1">
			...
			<a href="/form"><i class="fab fa-wpforms"></i><span>Form</span></a>
			<a href="/payment"><i class="fas fa-file-invoice"></i><span>Payment</span></a>
			<a href="#" data-menu="menu-settings" class="active-nav"><i class="fas fa-user-cog"></i><span>User Settings</span></a>
		</div>
		...
		<div class="page-content header-clear-small">
			...
			<div class="card card-style preload-img" data-src="/img/18w.jpg" data-card-height="130">
				<div class="card-center ms-3">
					<h1 class="color-white mb-0"><?= $title_page ?></h1>
				</div>
